...
int main(void)
{
	...
	char* path1="G:/WorkingFolder/MyOpenCVProject/StitchingTest/bin/Release/images/16bit/l_rot_8_16.png";
	char* path2="G:/WorkingFolder/MyOpenCVProject/StitchingTest/bin/Release/images/16bit/r_16.png";	
