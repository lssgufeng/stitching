...
/***
* @ class MyTimer
* @ description This class is targetted to measure the times 
	elapsed to do some task
* @ author Kenneth Wilder( from googlesite)
*/
class MyTimer
{
	friend std::ostream& operator<<(std::ostream& os, MyTimer& t);
...
public:
  ...
  MyTimer() : running(false), start_clock(0), start_time(0), acc_time(0) { }
...
inline double MyTimer::elapsed_time()
{
...
inline void MyTimer::start(const char* msg)
{
...
inline void MyTimer::restart(const char* msg)
{
...
inline void MyTimer::stop(const char* msg)
{
...
inline void MyTimer::check(const char* msg)
{
...
inline std::ostream& operator<<(std::ostream& os, MyTimer& t)
{
